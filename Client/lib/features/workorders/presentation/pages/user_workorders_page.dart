...
class UserWorkordersPage extends StatefulWidget {
  final int id;
  const UserWorkordersPage({Key? key, required this.id}) : super(key: key);

  @override
  UserWorkordersPageState createState() => UserWorkordersPageState();
}

class UserWorkordersPageState extends State<UserWorkordersPage> {
  ...
  Future<void> initialize() async {
    ...
    final workordersData =
        await workordersProvider.getWorkordersForUser(widget.id);
    setState(() {
